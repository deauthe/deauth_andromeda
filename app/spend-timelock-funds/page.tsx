...
const ShirtSalePage = () => {
    ...
    const timelock_distribute_funds = {
        hold_funds: {
            recipient: {
                "address": "andr1pt8zn23ch0fr888w6aa02crtgglvu90hzdaw8waskjm97ma97fdscnzt3n",
                "msg": "eyJzZW5kIjp7fX0="
            },
            condition: {
        ...
        <div className="container mx-auto py-8">
            ...
            <div className="flex items-center">
                ...
                <div className="w-1/2 pl-8">
                    ...
                    <Button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" onClick={() => distribute_funds_to_splitter()}>Confirm</Button>
                </div>
            </div>
        </div>
    );
